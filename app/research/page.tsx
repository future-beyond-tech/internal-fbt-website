        ...
        <Container>
          <div className="space-y-8">
            ...
            <article className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm transition-shadow hover:shadow-md dark:border-slate-800 dark:bg-slate-900">
              ...
              <p className="mt-4 text-base leading-relaxed text-slate-600 dark:text-slate-400">
                End-to-end deep dive on ISO 14971:2019 risk management, including
                risk planning, risk control hierarchy, residual risk analysis,
                benefit-risk evaluation, and post-market integration across IVD,
                SaMD, active implantables, and combination products.
              </p>
